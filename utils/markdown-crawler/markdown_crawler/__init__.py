...
#DEFAULT_TARGET_CONTENT = ['article', 'div', 'main', 'p', 'b','strong','li','meta','em','u', 'span', 'h1' , 'h2']
DEFAULT_TARGET_CONTENT = ['main__inner-container']
#DEFAULT_TARGET_LINKS = ['body', 'container']
DEFAULT_TARGET_LINKS = ['body', 'container']
...
def get_target_content(
    ...
    # ---------------------------
        ...
        class_name = 'main__inner-container'
